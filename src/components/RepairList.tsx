...
//         `https://edmnkjhrrk.execute-api.eu-west-3.amazonaws.com/api/repairs/${getEndpoint()}`
//       );
...
//     try {
//       setIsLoading(true);
//       await axios.delete(`https://edmnkjhrrk.execute-api.eu-west-3.amazonaws.com/api/repairs/${getEndpoint()}/${id}`);
...
//         await axios.put(
//           `https://edmnkjhrrk.execute-api.eu-west-3.amazonaws.com/api/repairs/${getEndpoint()}/${updatedRepair._id}`,
//           updatedRepair
//         );
//       } else {
//         // Add new repair
//         await axios.post(
//           `https://edmnkjhrrk.execute-api.eu-west-3.amazonaws.com/api/repairs`,
...
const RepairList: React.FC = () => {
  ...
  const handleSaveOption = async (option: RepairOption) => {
    try {
      ...
      if (isNewOption) {
        // Add new option
        await axios.post(
          `https://edmnkjhrrk.execute-api.eu-west-3.amazonaws.com/api/repairs/${getEndpoint()}/${currentRepair._id}/options`,
          option
        );
      } else if (option._id) {
        // Update existing option
        await axios.put(
          `https://edmnkjhrrk.execute-api.eu-west-3.amazonaws.com/api/repairs/${getEndpoint()}/${currentRepair._id}/options/${option._id}`,
          option
        );
      }
      closeModals();
  ...
  const handleDeleteOption = async (repairId: string, optionId: string) => {
    try {
      setIsLoading(true);
      await axios.delete(
        `https://edmnkjhrrk.execute-api.eu-west-3.amazonaws.com/api/repairs/${getEndpoint()}/${repairId}/options/${optionId}`
      );
      fetchRepairs(); // Refresh the list
    } catch (err) {
...
//       setIsLoading(true);
//       try {
//         const brandsRes = await axios.get(`https://edmnkjhrrk.execute-api.eu-west-3.amazonaws.com/api/brands/${type}`);
...
//       if (isNewOption) {
//         await axios.post(
//           `https://edmnkjhrrk.execute-api.eu-west-3.amazonaws.com/api/repairs/${endpoint}/${currentRepair._id}/options`,
//           currentOption
//         );
//       } else if (currentOption._id) {
//         await axios.put(
//           `https://edmnkjhrrk.execute-api.eu-west-3.amazonaws.com/api/repairs/${endpoint}/${currentRepair._id}/options/${currentOption._id}`,
//           currentOption
//         );
//       }
