...
//     try {
//       const response = await axios.post('https://edmnkjhrrk.execute-api.eu-west-3.amazonaws.com/api/repairs', formData);
  ...
  useEffect(() => {
    ...
    const fetchBrands = async () => {
      ...
      try {
        ...
        // const response = await axios.get(`https://edmnkjhrrk.execute-api.eu-west-3.amazonaws.com/api/brands?category=${formData.category}`);
